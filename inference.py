...
if __name__ == '__main__':
    ...
    predictor.initialize_from_trained_model_folder(
        join(nnUNet_results, '/root/autodl-tmp/nnUNet-master/dataset/nnUNet_results/Dataset012_Airwayfull/nnUNetTrainer_250epochs__nnUNetPlans__3d_fullres'),
        use_folds=(0, ),
        checkpoint_name='checkpoint_best.pth',
    )
    predictor.predict_from_files(join(nnUNet_raw, '/root/autodl-tmp/nnUNet-master/dataset/nnUNet_raw/Dataset012_Airwayfull/imagesTs-test'),
                                 join(nnUNet_raw, '/root/autodl-tmp/nnUNet-master/dataset/nnUNet_raw/Dataset012_Airwayfull/imagesTs_predlowres'),
    ...
    img, props = SimpleITKIO().read_images([join(nnUNet_raw, 'Dataset012_Airwayfull/imagesTs')])
